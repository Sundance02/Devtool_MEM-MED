# Generated by Django 5.1.1 on 2024-10-08 08:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schedule', models.CharField(choices=[('ตอนเช้า', 'ตอนเช้า'), ('ตอนกลางวัน', 'ตอนกลางวัน'), ('ตอนเย็น', 'ตอนเย็น'), ('ตอนกลางคืน', 'ตอนกลางคืน')], max_length=10)),
                ('before_after', models.CharField(choices=[('ก่อนอาหาร', 'ก่อนอาหาร'), ('หลังอาหาร', 'หลังอาหาร')], max_length=10)),
                ('is_eaten', models.BooleanField(null=True)),
